function GUI (w, h) {
  ...
  this.render = function () {
    ...
    if (!spaceUp) {
      image(shootingPrepAnimation[frameCount], monster.pos.x-monster.rad/6-(fireBallDmgRad/20), monster.pos.y+monster.rad/2-(fireBallDmgRad/20), (monster.rad/3)+(fireBallDmgRad/10), (monster.rad/3)+(fireBallDmgRad/10));
      if (maxFrames % 3 == 0) {
        frameCount ++;
      }
      maxFrames ++;
